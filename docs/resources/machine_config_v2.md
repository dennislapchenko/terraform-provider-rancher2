...
* `datacenter_name` - (Optional) Ionos Cloud Virtual Data Center Name. (string)
...
* `lan_name` - (Optional) Ionos Cloud LAN Name. (string)
...
* `server_cores` - (Optional) Ionos Cloud Server Cores (2, 3, 4, 5, 6, etc.). (int)
...
* `server_ram` - (Optional) Ionos Cloud Server RAM in MB (1024, 2048, 3072, 4096, etc.). (int)
